...
namespace IAmBacon.Core.Application.Tests.User.Commands
{
    ...
    public class CreateUserCommandTests
    {
        ...
        {
            Because of = () => _exception = Catch.Exception(() => _sut = new CreateUserCommand(null, null, null, null, null));
        ...
        {
            Because of = () => _exception = Catch.Exception(() => _sut = new CreateUserCommand("joe", null, null, null, null));
        ...
        {
            Because of = () => _exception = Catch.Exception(() => _sut = new CreateUserCommand("joe", "bloggs", null, null, null));
        ...
        {
            Because of = () => _exception = Catch.Exception(() => _sut = new CreateUserCommand("joe", "bloggs", "joe@blogs.com", null, null));
        ...
        {
            Because of = () => _exception = Catch.Exception(() => _sut = new CreateUserCommand("joe", "bloggs", "joe@blogs.com", "image.png", null));
